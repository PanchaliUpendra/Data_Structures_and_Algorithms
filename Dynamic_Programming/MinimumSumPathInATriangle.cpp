...
#include<bits/stdc++.h>
using namespace std;
int funans(vector<vector<int>>&grid,int r,int c,int m,int n){
	if(r==m) return 0;
	return grid[r][c]+min(funans(grid,r+1,c+1,m,n),funans(grid,r+1,c,m,n));
...
int main(){
	...
	cout<<"the minimum sum of the triangle is: "<<funans(grid,0,0,n,n);
	return 0;
}
*/

//using memoization using C++
